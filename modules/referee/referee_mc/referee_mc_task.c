...
static TaskHandle_t referee_task_handle = NULL;
...
referee_info_t *RobotRefereeInfoInit(UART_HandleTypeDef *referee_usart_handle, Referee_Interactive_info_t *UI_data)
{
    ...
    referee_task_handle = osThreadNew(RefereeInfoTask, NULL, &referee_task_attributes);
